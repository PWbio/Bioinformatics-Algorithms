""" Modified from Original Source: https://nbviewer.jupyter.org/gist/BenLangmead/6665861 """
...
class SuffixTree(object):
    ...
    def __init__(self, s):
        ...
        self.root.out[s[0]] = self.Node(s)  # trie for just longest suf (add longest label to
